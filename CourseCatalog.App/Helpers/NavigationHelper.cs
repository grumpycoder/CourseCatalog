...
namespace CourseCatalog.App.Helpers
{
    ...
    {
        public static MvcHtmlString BsNavigationLink(this HtmlHelper html, string linkText, string action,
            string controller, string icon = null, object routeValues = null, object css = null)
        {
            ...
            if (icon != null) imageIcon = $@"<i class='{icon} visible-sm'>&nbsp;</i>&nbsp;&nbsp;";
            ...
            if (activeRouteController == controller ||
                activeRouteController == controller && activeRouteAction == action) liTag.AddCssClass("active");
        ...
        public static string IsLinkActive(this UrlHelper url, string action, string controller)
        {
            ...
            if (activeRouteController == controller ||
                activeRouteController == controller && activeRouteAction == action) return "active";
