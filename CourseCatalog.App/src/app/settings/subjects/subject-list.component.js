...
function controller($http) {
        ...
        $http.get('/api/refs/subjects').then(r => {
            ...
            ctrl.groupListOptions = {
                ...
                onItemDeleting: function (item) {
                    var d = $.Deferred();
                    var url = '/api/refs/subjects/' + item.itemData.subjectId;
    ...
    function codeInUse(code) {
        ...
        var inUse = ctrl.subjects.find(t => t.subjectCode.toLowerCase() === code.toLowerCase()) !== undefined;
        return inUse;
    }
