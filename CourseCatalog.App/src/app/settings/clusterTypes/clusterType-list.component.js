...
function controller($http) {
        ...
        $http.get("/api/refs/clusterTypes").then(r => {
            ...
            ctrl.groupListOptions = {
                ...
                onItemDeleting: function(item) {
                    var d = $.Deferred();
                    const url = `/api/refs/clusterTypes/${item.itemData.clusterTypeId}`;
    ...
    ctrl.onSubmit = function() {
        const url = "/api/refs/clusterTypes";
    ...
    function codeInUse(code) {
        ...
        const inUse = ctrl.clusterTypes.find(t => t.name.toLowerCase() === code.toLowerCase()) !== undefined;
        return inUse;
    }
