...
function controller($http) {
        ...
        $http.get("/api/refs/programTypes").then(r => {
            ...
            ctrl.groupListOptions = {
                ...
                onItemDeleting: function(item) {
                    var d = $.Deferred();
                    const url = `/api/refs/programTypes/${item.itemData.programTypeId}`;
    ...
    ctrl.onSubmit = function() {
        const url = "/api/refs/programTypes";
    ...
    function codeInUse(code) {
        ...
        const inUse = ctrl.programTypes.find(t => t.programTypeCode.toLowerCase() === code.toLowerCase()) !== undefined;
        return inUse;
    }
