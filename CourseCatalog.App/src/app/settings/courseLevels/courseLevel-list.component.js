...
function controller($http) {
        ...
        $http.get("/api/refs/courseLevels").then(r => {
            ...
            ctrl.groupListOptions = {
                ...
                onItemDeleting: function(item) {
                    var d = $.Deferred();
                    const url = `/api/refs/courselevels/${item.itemData.courseLevelId}`;
    ...
    ctrl.onSubmit = function() {
        const url = "/api/refs/courselevels";
    ...
    function codeInUse(code) {
        ...
        const inUse = ctrl.courseLevels.find(t => t.courseLevelCode.toLowerCase() === code.toLowerCase()) !== undefined;
        return inUse;
    }
