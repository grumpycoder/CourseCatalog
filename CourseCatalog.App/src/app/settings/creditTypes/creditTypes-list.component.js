...
function controller($http) {
        ...
        $http.get("/api/refs/creditTypes").then(r => {
            ...
            ctrl.groupListOptions = {
                ...
                onItemDeleting: function(item) {
                    var d = $.Deferred();
                    const url = `/api/refs/creditTypes/${item.itemData.tagId}`;
    ...
    ctrl.onSubmit = function() {
        const url = "/api/refs/creditTypes";
    ...
    function codeInUse(code) {
        ...
        const inUse = ctrl.creditTypes.find(t => t.name.toLowerCase() === code.toLowerCase()) !== undefined;
        return inUse;
    }
