    ...
    ctrl.$onInit = function () {
        ...
        ctrl.dataGridOptions = {
            ...
            columns: [
                ...
                { dataField: 'credentialTypeName', caption: 'Type', width: 110, dataType: 'string' },
                ...
                { dataField: 'beginYear', caption: 'Begin', dataType: 'int' },
                { dataField: 'endYear', caption: 'End', dataType: 'int' },
                {
                    caption: '',
                    width: 75,
                    cssClass: 'center-col',
