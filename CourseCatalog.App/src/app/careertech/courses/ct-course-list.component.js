...
function controller($http) {
        ...
        ctrl.dataGridOptions = {
            dataSource: new DevExpress.data.CustomStore({
                ...
                update: function (key, values) {
                    ...
                    var url = `/api/courses/${ctrl.selectedCourse.id}/cip/${values.cipCode}/`;
    ...
    ctrl.removeProgram = function (program) {
        var url = `/api/courses/${ctrl.selectedCourse.id}/programs/${program.programId}`;;
    ...
    ctrl.addProgram = function (program) {
        var url = `/api/courses/${ctrl.selectedCourse.id}/programs`;
        var dto = {
