...
{
    public class
        CreateProgramCredentialCommandHandler : IRequestHandler<CreateProgramCredentialCommand,
            CreateProgramCredentialDto>
    {
        ...
        public async Task<CreateProgramCredentialDto> Handle(CreateProgramCredentialCommand request,
            CancellationToken cancellationToken)
        {
            ...
            programCredential =
                programToUpdate.Credentials.FirstOrDefault(c =>
