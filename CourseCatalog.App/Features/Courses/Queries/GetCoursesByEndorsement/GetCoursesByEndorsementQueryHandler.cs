...
{
    public class
        GetCoursesByEndorsementQueryHandler : IRequestHandler<GetCoursesByEndorsementQuery,
            List<EndorsementCourseListDto>>
    {
        ...
        public async Task<List<EndorsementCourseListDto>> Handle(GetCoursesByEndorsementQuery request,
